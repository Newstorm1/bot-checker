...
$MadelineProto = new API('7.madeline', $settings);
$MadelineProto->start();
$x= file_get_contents('x7');
$info = json_decode(file_get_contents('info.json'),true);
$num = $info["number7"];
$chat_mack = file_get_contents("o7");
do{
...
bot('sendvideo', ['video' =>'https://t.me/gg98vc/2', 'chat_id' => file_get_contents("ID"), 'caption' => "⌯ Catch ❲ 7 ❳ New Take 🦅'",]);
                        ...
                        if($e->getMessage() == "USERNAME_INVALID"){
                        	bot('sendvideo', ['video' =>'https://t.me/gg98vc/2', 'chat_id' => file_get_contents("ID"), 'caption' => "╭ checker ❲ 7 ❳  \n | username is Band\n╰ Done Delet on list ↣ @$user",]);
                            $data = str_replace("\n".$user,"", file_get_contents("u7"));
                            file_put_contents("u7", $data);
                        ...
                        file_put_contents("u7", $data);
                            ...
                            bot('sendvideo', ['video' =>'https://t.me/gg98vc/2', 'chat_id' => file_get_contents("ID"), 'caption' => "╭ checker ❲ 7 ❳ 🛎 \n | username not save\n╰ FLood 1500 ↣ @$user",]);
                             ...
                             $data = str_replace("\n".$user,"", file_get_contents("u7"));
                            file_put_contents("u7", $data);
                            bot('sendvideo', ['video' =>'https://t.me/gg98vc/2', 'chat_id' => file_get_contents("ID"), 'caption' => "7 •CHANNELS_ADMIN_PUBLIC_TOO_MUCH : @$user",]);                          
                        }else{
                            bot('sendvideo', ['video' =>'https://t.me/gg98vc/2', 'chat_id' => file_get_contents("ID"), 'caption' =>  "7 • Error @$user ".$e->getMessage()
]);exit;
$info = json_decode(file_get_contents('info.json'),true);
