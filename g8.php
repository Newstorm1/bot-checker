...
if($from_id == $sudo){
try{
if(file_get_contents("step8") == "2"){
if($text !== "Login8"){
  file_put_contents('phone8',$text);
$MadelineProto->phonelogin($text);
$tg->vtcor('sendmessage',[
'chat_id'=>$chat_id, 
'text'=>"⌁ Checker number - 8 - \n⌁ Send Code Phone Now \n⌁ Ex : - 67467 -",
]);
file_put_contents("step8","3");
}
}elseif(file_get_contents("step8") == "3"){
if($text){
...
}elseif(file_get_contents("step8") == "4"){
if($text){
