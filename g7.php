...
if($from_id == $sudo){
try{
if(file_get_contents("step7") == "2"){
if($text !== "Login7"){
  file_put_contents('phone7',$text);
$MadelineProto->phonelogin($text);
$tg->vtcor('sendmessage',[
'chat_id'=>$chat_id, 
'text'=>"⌁ Checker number - 7 - \n⌁ Send Code Phone Now \n⌁ Ex : - 67467 -",
]);
file_put_contents("step7","3");
}
}elseif(file_get_contents("step7") == "3"){
if($text){
...
}elseif(file_get_contents("step7") == "4"){
if($text){
