...
if($from_id == $sudo){
try{
if(file_get_contents("step6") == "2"){
if($text !== "Login6"){
  file_put_contents('phone6',$text);
$MadelineProto->phonelogin($text);
$tg->vtcor('sendmessage',[
'chat_id'=>$chat_id, 
'text'=>"⌁ Checker number - 6 - \n⌁ Send Code Phone Now \n⌁ Ex : - 67467 -",
]);
file_put_contents("step6","3");
}
}elseif(file_get_contents("step6") == "3"){
if($text){
...
}elseif(file_get_contents("step6") == "4"){
if($text){
