...
if($from_id == $sudo){
try{
if(file_get_contents("step2") == "2"){
if($text !== "Login2"){
  file_put_contents('phone2',$text);
$MadelineProto->phonelogin($text);
$tg->vtcor('sendmessage',[
'chat_id'=>$chat_id, 
'text'=>"⌁ Checker number - 2 - \n⌁ Send Code Phone Now \n⌁ Ex : - 67467 -",
]);
file_put_contents("step2","3");
}
}elseif(file_get_contents("step2") == "3"){
if($text){
...
}elseif(file_get_contents("step2") == "4"){
if($text){
